...
void subscriber_subscribe_ipc_channel(int sock_fd, uint32_t sub_id, ipc_type_t ipc_type, ipc_struct_t *ipc_struct)
{
    ...
    cmsg_t *subscriber_ipc_msg = cmsg_data_prepare2(SUBS_TO_COORD, SUB_MSG_IPC_CHANNEL_ADD, 0, TLV_OVERHEAD_SIZE + tlv_size);
    ...
    tlv_buffer_inser_tlv(tlv_buffer, ipc_tlv, tlv_size, NULL);
    ...
    case TLV_IPC_TYPE_MSGQ:
    {
        ...
        strncpy(msgq_name, ipc_struct->msgq.MsgQName, sizeof(ipc_struct->msgq.MsgQName));
    }
    break;
